...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${artifactId}.helpers;
...
import ${package}.frameworkForTraining.helpers.GetElementFromLocators;
import ${package}.frameworkForTraining.helpers.WaitForElement;
